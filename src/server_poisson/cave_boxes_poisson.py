...
with open(f'boxes_{int(1/scale)}_poisson.csv', mode='w', newline='') as file:
...
print(f"Boxes have been exported to 'boxes_{int(1/scale)}_poisson.csv'")


def write_vtk_file(boxes_real, filename=f'boxes{int(1/scale)}_poisson.vtk'):
...
write_vtk_file(boxes_real, f'boxes_{int(1/scale)}_poisson.vtk')
